...
import AddPartsMaterialForm from './AddPartsMaterialForm/AddPartsMaterialForm';
        ...
        <div>
          <div style={{ marginTop: '50px' }}>
            ...
            >
              ...
              <Link style={{ textDecoration: 'none' }} to={'/admin/parts'}>
...
export default AddPartsMaterial;
