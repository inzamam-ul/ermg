...
const DigitalStudio = () => {
  ...
  //handle materials
  const handleMaterialsDelete = element => {
    const newArray = material.filter(
      ele => ele.materialImg !== element.materialImg
    );
    setMaterial(newArray);
  };
  let materialCount = material.length;
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Box variant="div" style={{ marginBottom: '30px' }} m={2}>
                    ...
                    >
                      ...
                      <Link
                        style={{ color: 'black' }}
                        to={'/admin/digital-studio/addMaterial'}
                      >
                    ...
                    {material.map(ele => {
                      return (
                        ...
                        >
                          <Tooltip title="Delete" placement="top">
                            <DeleteIcon
                              onClick={() => handleMaterialsDelete(ele)}
                              style={{
                                cursor: 'pointer',
                                display: 'flex',
                                marginLeft: 'auto',
                    ...
                    <Link
                      ...
                      to={'/admin/digital-studio/addMaterial'}
                    >
                      <Tooltip title="Add Materials" placement="bottom">
                        <AddIcon
                          style={{
                            cursor: 'pointer',
                            margin: '0 10px',
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Box variant="div" style={{ marginBottom: '30px' }} m={2}>
                    ...
                    >
                      ...
                      <Link
                        style={{ color: 'black' }}
                        to={'/admin/digital-studio/addDimension'}
                      >
                        <Tooltip title="Add Dimensions" placement="top">
                          <AddIcon
                            style={{
                              cursor: 'pointer',
                            }}
                    ...
                    <Link
                      ...
                      to={'/admin/digital-studio/addDimension'}
                    >
                      <Tooltip title="Add Dimensions" placement="bottom">
                        <AddIcon
                          style={{
                            cursor: 'pointer',
                            margin: '0 10px',
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Box variant="div" style={{ marginBottom: '30px' }} m={2}>
                    ...
                    >
                      ...
                      <Link
                        style={{ color: 'black' }}
                        to={'/admin/digital-studio/addcomponent'}
                      >
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Box variant="div" style={{ marginBottom: '30px' }} m={2}>
                    ...
                    >
                      ...
                      <Link
                        style={{ color: 'black' }}
                        to={'/admin/digital-studio/addOtherCard'}
                      >
                        <Tooltip title="Add Reference images" placement="top">
                          <AddIcon
                            style={{
                              cursor: 'pointer',
                            }}
                    ...
                    <Link
                      ...
                      to={'/admin/digital-studio/addOtherCard'}
                    >
                      <Tooltip title="Add Reference images" placement="bottom">
                        <AddIcon
                          style={{
                            cursor: 'pointer',
                            margin: '0 10px',
